...
<footer class="footer-base">
    <div class="content">
      <div class="container">
        ...
        <div class="row copy-row">
          <div class="col-md-12 copy-text">
            <div class="tag-row"> <span><a href="{{ url('advocate-signup') }}">Join Our Lawyers NetWork</a></span> <span><a href="{{ url('legal/lawyers-terms') }}">Lawyers Terms</a></span> <span><a href="{{ url('legal/indian-panel-code') }}">IPC Sectons</a></span> </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>504, 5th Floor, Block-A Spaze I-Tech Park sector -49 Gurugram 122001</p>
            <p><i class="fa fa-phone"></i> +91 9354419320 &nbsp; <i class="fa fa-envelope"></i> <a href="mailto:contact@kanoonvala.com">contact@kanoonvala.com</a>  &nbsp; <i class="fa fa-globe"></i> <a href="http://www.kanoonvala.com" >www.kanoonvala.com </a></p>
            <hr class="space xs" />
            ...
            <div class="btn-group navbar-social">
              <div class="btn-group social-group"><p>Kanoonvala.com is not advertising services for lawyers, we are providing platform there make transparency between customer and legal advice, Our Rating/Ranking based on customer details and feedback.Kanoonvala does not provide any legal services for any customer</p></div>
            </div>
      ...
      <div class="row copy-row">
      <div class="col-md-12 copy-text">© 2018 Kanoonvala All right reserved. 
        | <a href="{{ url('terms/terms-of-use') }}">Terms of use</a>
        | <a href="{{ url('terms/privacy-policy') }}">Privacy Policy</a>
        | <a href="{{ url('terms/return-policy') }}">Refund Policy</a>
      </div>
      </div>
    </div>
  </footer>
