                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="row">
                      <div class="col-md-12 anima">
                        <h1 class="text-white text-l heading_one">Join Now to Company HR Documents Online For <br>
                          <span>Just INR 20000/-</span>Choose an all-inclusive optimum legal solution for your business with Kanoonvala.com!</h1>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="container">
          <div class="main-heading text-center" style="color:black;">
            ...
            <div class="slices"><span class="slice"></span><span class="slice"></span><span class="slice"></span>
              <p style="color:black;">When you are starting a Startup, it is essential that you have all your documentation and legal requirements set up and in order. You must clearly lay down your company HR policies in a formal document which elaborates upon the values and expectations that your company has from your employees, compliance with existing labour laws, best practices for your company, etc.</p>
              <p style="color:black;">You must clearly lay down the policies, i.e., the rules and principles by which your organization functions, and the procedures that lay down how these policies must be implemented by your employees. You must hire the top Startup lawyers in your locality to help you draft an HR document that is good in law.</p>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-6 left-responsive">
              ...
              <p>- 20 minutes call to get acquainted with your lawyer and to understand the work that is to be undertaken together.</p>
            ...
            <div class="col-md-6 left-responsive">
              ...
              <hr style="border:2px solid #612f31;">
              <p>-  The lawyer shall not undertake any work in addition to the drafting of the HR documents</p>
              <p>- You may hire the lawyer for any additional Startup related work that you may have</p>
            </div>
          ...
          <div class="row">
            <div class="col-md-6 left-responsive">
              ...
              <ul>
                ...
                <li>4. Documents stating standards of conduct, punctuality, etc., of the employees</li>
                <br>
                <h4 style="color:black;">Procedure for Drafting Company HR Documents</h4>
                <li>1. You must hire the top Startup lawyers in your locality to help you draft an HR document tailored to meet your specific needs and circumstances</li>
                <li>2. The HR document letter shall be drafted and sent to you for approval.</li>
                <li>3. The HR document letter shall be drafted incorporating your suggestions(if any).</li>
              </ul>
			</div>
              <div class="col-md-6 left-responsive">
                <div class="card">
